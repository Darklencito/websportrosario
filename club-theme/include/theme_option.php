      ...
      <div class="row"> 
            ...
            <div class="main-nav">
                 <ul class="sub-menu categoryitems" style="display:block">
                    <li class="logo"><a href="#"><img src="<?php echo get_template_directory_uri()?>/images/admin/logo.png" /></a></li>
 	                <li><i class="fa fa-cogs"></i><a href="#tab-color" onClick="toggleDiv(this.hash);return false;">Config. General</a></li>
                    <li><i class="fa fa-picture-o"></i><a href="#tab-logo" onClick="toggleDiv(this.hash);return false;">Logo / Favicon</a></li>
                    <li><i class="fa fa-tasks"></i><a href="#tab-head-scripts" onClick="toggleDiv(this.hash);return false;">Config. Cabecera</a></li>
                    <li><i class="fa fa-tasks"></i><a href="#tab-footer-setting" onClick="toggleDiv(this.hash);return false;">Config. Pie Pagina</a></li>
                    <li><i class="fa fa-chain-broken"></i><a href="#tab-api-key" onClick="toggleDiv(this.hash);return false;">Mailing</a></li>
                    <li><i class="fa fa-tasks"></i><a href="#tab-other" onClick="toggleDiv(this.hash);return false;">Otra Configuracion</a></li>
                    <li><i class="fa fa-table"></i><a href="#tab-pointstable-settings" onClick="toggleDiv(this.hash);return false;">Tabla de Puntos</a></li>
                    <li><i class="fa fa-bullhorn"></i><a href="#tab-advertisement-banner" onClick="toggleDiv(this.hash);return false;">Config. Banner</a></li>
                    <li><i class="fa fa-users"></i><a href="#tab-social-sharing" onClick="toggleDiv(this.hash);return false;">Redes Sociales</a></li>
                    <li><i class="fa fa-globe"></i><a href="#tab-upload-languages" onClick="toggleDiv(this.hash);return false;">Traducciones</a></li>
                    <li><i class="fa fa-columns"></i><a href="#tab-manage-sidebars" onClick="toggleDiv(this.hash);return false;">Admin. Sidebar</a></li>
                    <li><i class="fa fa-columns"></i><a href="#tab-default-pages" onClick="toggleDiv(this.hash);return false;">Pagina Defecto</a></li>
                    <li><i class="fa fa-floppy-o"></i> <a href="#tab-import-export" onClick="toggleDiv(this.hash);return false;">Backup Plantilla</a></li> 
                     <li class="to-field">
                     <i class="fa fa-paste"></i>
                        <input type="button" value="Restaurar Cambios" onclick="px_to_restore_default('<?php echo admin_url('admin-ajax.php');?>', '<?php echo get_template_directory_uri()?>')" />
                     </li>      
                </ul>
            </div>
            <div class="clear"></div>
        ...
        <div class="col2">
          ...
          <div id="tab-color">
            ...
            <div class="opt-head">
              <h4>Configuración de Colores</h4>
              <div class="clear"></div>
            </div>
            <ul class="form-elements">
              
              <li class="to-field">
              <label class="to-label">Personalizar Colores</label>
            ...
            <ul class="form-elements noborder">
              ...
              <li class="to-field">
              	<label class="to-label">Color de Fondo</label>
            ...
            <ul class="form-elements noborder">
              ...
              <li class="to-field">
              	<label class="to-label">Color Fondo Navegación</label>
            ...
            <ul class="form-elements noborder">
              ...
              <li class="to-field">
              	<label class="to-label">Color Fuente Navega.</label>
            ...
            <div class="theme-help">
              <h4 style="padding-bottom:0px;">Opción de Diseño</h4>
              <div class="clear"></div>
            </div>
             <ul class="form-elements">
              <li class="to-label">
            ...
            <div class="clear"></div>
            <div class="theme-help">
              <h4 style="padding-bottom:0px;">Opción de Fondo</h4>
              <div class="clear"></div>
            </div>
            <ul class="form-elements">
              <li class="to-label">
            ...
            <ul class="form-elements">
              ...
              <li class="full">&nbsp;</li>
              <li class="to-label">
                <label>Subir Patron de Fondo</label>
              </li>
              <li class="to-field">
            ...
            <ul class="form-elements">
              ...
              <li class="to-field">
                ...
                <p>Pegar el codigo de Google Analytics<br />
                  Para agregar en el template.</p>
              </li>
            </ul>
          </div>
          <!-- Color And Style End --> 
          ...
          <div id="tab-logo" style="display:none;">
            <div class="theme-header">
              <h1>Logo / Configuracion Favicon</h1>
            </div>
            <div class="opt-head">
              <h4>Configuracion de Logo</h4>
              <div class="clear"></div>
            </div>
            <ul class="form-elements">
              <li class="to-label">
            ...
            <div class="opt-head">
              <h4>Configurar Favicon</h4>
              <div class="clear"></div>
            </div>
            
            <ul class="form-elements">
               <li class="to-label">
                <label>Sugir Favicon</label>
              </li>
              <li class="to-field">
          ...
          <div id="tab-head-scripts" style="display:none;">
            <div class="theme-header">
              <h1>Configuracion de Cabecera </h1>
            </div>
            ...
            <li class="to-label">
              ...
              <li class="to-field">
                <select name="fixture_type">
                  ...
                  <?php
                  ?>
                  <option <?php if(isset($px_theme_option['fixture_type']) and $px_theme_option['fixture_type']=='All')echo "selected"?>>Todo</option>
                  <option <?php if(isset($px_theme_option['fixture_type']) and $px_theme_option['fixture_type']=='Fixtures')echo "selected"?>>Fixtures</option>
                  <option <?php if(isset($px_theme_option['fixture_type']) and $px_theme_option['fixture_type']=='Results')echo "selected"?>>Resultados</option>
                </select>
               </li>
               </ul>
             ...
             <ul class="form-elements noborder">
              ...
              <li class="to-field">
                <select name="fixture_order">
                  ...
                  <?php
                  ?>
                  <option value="ASC" <?php if(isset($px_theme_option['fixture_order']) and $px_theme_option['fixture_order']=='ASC')echo "selected"?>>Ascendente</option>
                  <option value="DESC" <?php if(isset($px_theme_option['fixture_order']) and $px_theme_option['fixture_order']=='DESC')echo "selected"?>>Descendente</option>
                </select>
               </li>
               </ul>
              ...
              <ul class="form-elements noborder">
              <li class="to-label">
                <label>Seleccionar Categoria de Equipos</label>
              </li>
              <li class="to-field">
